# Generated by Django 5.0.2 on 2024-04-16 18:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('STUDENT', 'Student'), ('TEACHER', 'Teacher')], max_length=50, unique=True)),
                ('last_generated_id', models.IntegerField(default=0)),
            ],
        ),
        migrations.CreateModel(
            name='STUDENTCSV',
            fields=[
                ...
                ('CSV_file', models.FileField(null=True, upload_to='student_csvs')),
